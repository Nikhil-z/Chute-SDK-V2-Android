...
public class StoreDeleteStorage extends
    ParameterHttpRequestImpl<ResponseModel<StoreModel>> {
  ...
  public StoreDeleteStorage(Context context, final StoreType type, final String key,
    ...
    super(context, RequestMethod.DELETE,
        new ResponseParser<StoreModel>(StoreModel.class),
        callback);
    if (type == null) {
