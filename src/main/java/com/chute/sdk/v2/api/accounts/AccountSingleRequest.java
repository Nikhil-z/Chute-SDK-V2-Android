...
class AccountSingleRequest extends ParameterHttpRequestImpl<ResponseModel<AccountBaseModel>> {
	...
	public AccountSingleRequest(Context context, String accountName, String accountShortcut, String folderId,
	...
	protected String getUrl() {
		return String.format(RestConstants.URL_ACCOUNT_SINGLE, accountName, accountShortcut, folderId);
	}
